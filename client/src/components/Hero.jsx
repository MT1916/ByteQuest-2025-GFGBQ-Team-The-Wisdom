    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden bg-pattern">
            ...
            <div className="container mx-auto px-4 text-center relative z-10">
                ...
                >
                    <button className="w-full sm:w-auto flex items-center justify-center gap-2 bg-primary hover:bg-primary-light text-white px-8 py-4 rounded-xl font-semibold transition-all shadow-lg hover:shadow-xl hover:-translate-y-1">
                        Start Giving <ArrowRight size={20} />
                    </button>
                    <button className="w-full sm:w-auto flex items-center justify-center gap-2 bg-white border border-primary/20 hover:border-primary text-primary-dark px-8 py-4 rounded-xl font-semibold transition-all hover:bg-custom-offwhite">
                        Learn More
                    </button>
                </motion.div>
            </div>
